...
class CseFour extends React.Component{
   ...
   render(){
    ...
    return(
        <div class="background6">
            ...
            <div class="deptname">
                <marquee direction="right">Computer Science and Enginerring</marquee>
            </div>
            ...
            <Link to="/Csevl"><div className="App2">
