...
class Csesn extends React.Component{
    ...
    return(
        ...
        <div class="wrapper1">
            ...
            <div class="info">
                ...
                <Link to="/Csemath"><button>Calculate</button></Link>
            </div>
            </div>
        </div>
        ...
        <div class="wrapper2">   
            ...
            <div class="info">
                ...
                <Link to="/Csejava"><button>Code</button></Link>
            </div>
            </div>
        </div>
        ...
        <div class="card0"><img src={web}/>
            ...
            <Link to="/Cseweb"><button>Develop</button></Link>
            </div>
        </div>
        </div>
